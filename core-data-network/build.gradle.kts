...
dependencies {
    ...
    implementation("com.rocket.core:core-data-network-commons:0.0-beta0-SNAPSHOT20230117")

    testImplementation("com.rocket.android.core:core-data-network-test:0.0-beta0-SNAPSHOT20230117")
